...
<div class="row">
	<div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
			<div class="x_title">
				<h2>Laporan Pembelian Pertanggal</h2>
			...
			<div class="x_content">
				...
				<form action="<?=  base_url("example/cari_laporan_beli");  ?>" method="post" >
				...
				<table id="datatable-buttonss" class="table table-striped table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td>Rp <?php echo number_format($i->harga_beli) ?></td>
							<td><?php echo $i->banyak ?></td>
							<td>Rp <?php echo number_format($i->subtotal) ?></td>
							<td><?php echo $i->nama_pemasok ?></td>
